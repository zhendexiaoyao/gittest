		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo ($row['gallery'][0]); ?>-l" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php echo ($row['gallery'][0]); ?>-m" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<?php if(is_array($row["gallery"])): foreach($row["gallery"] as $key=>$img): if(($key) == "0"): ?><li class="cur">
											<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo ($img); ?>-m',largeimage: '<?php echo ($img); ?>-l'}"><img src="<?php echo ($img); ?>-s"></a>
										</li>
										<?php else: ?>
										<li class="">
											<a class="" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo ($img); ?>-m',largeimage: '<?php echo ($img); ?>-l'}"><img src="<?php echo ($img); ?>-s"></a>
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="<?php echo U('Cart/add2cart');?>" method="post" class="choose">
						<ul>
							<li>
								<dl>
									<dt>购买数量：</dt>
