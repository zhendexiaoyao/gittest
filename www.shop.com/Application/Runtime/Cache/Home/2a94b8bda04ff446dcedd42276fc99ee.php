...
<!-- 头部 end-->
		...
		<div class="slide fl">
			<div class="area">
				<div class="slide_items">
					<ul>
						<?php if(is_array($rs)): foreach($rs as $key=>$row): ?><li><a href="<?php echo ($row["url"]); ?>"><img src="<?php echo ($row["path"]); ?>" alt="<?php echo ($row["notice"]); ?>" /></a></li><?php endforeach; endif; ?>
					</ul>
				</div>
				<div class="slide_controls">
					<ul>
						<?php if(is_array($rs)): foreach($rs as $key=>$row): ?><li class="on"><?php echo ($key+1); ?></li><?php endforeach; endif; ?>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="guide w1210 bc mt15">
		...
		<div class="guide_content fl">
			<h2>
				<span class="on">精品</span>
				<span>新品</span>
				<span class="last">热销</span>
			</h2>
			...
			<div class="guide_wrap">
				...
				<div class="best">
					<ul>
						<?php if(is_array($is_good)): foreach($is_good as $key=>$goods): ?><li>
								<dl>
									<dt><a href="<?php echo U('Index/goods',['id'=>$goods['id']]);?>"><img src="<?php echo ($goods["logo"]); ?>" alt="<?php echo ($goods["name"]); ?>" /></a></dt>
				...
				<div class="new">
					<ul>
						<?php if(is_array($is_new)): foreach($is_new as $key=>$goods): ?><li>
								<dl>
									<dt><a href="<?php echo U('Index/goods',['id'=>$goods['id']]);?>"><img src="<?php echo ($goods["logo"]); ?>" alt="<?php echo ($goods["name"]); ?>" /></a></dt>
									<dd><a href="<?php echo U('Index/goods',['id'=>$goods['id']]);?>"><?php echo ($goods["name"]); ?></a></dd>
									<dd><span>售价：</span><strong> ￥<?php echo ($goods["shop_price"]); ?></strong></dd>
				...
				<div class="hot">
					<ul>
						<?php if(is_array($is_hot)): foreach($is_hot as $key=>$goods): ?><li>
								<dl>
									<dt><a href="<?php echo U('Index/goods',['id'=>$goods['id']]);?>"><img src="<?php echo ($goods["logo"]); ?>" alt="<?php echo ($goods["name"]); ?>" /></a></dt>
									<dd><a href="<?php echo U('Index/goods',['id'=>$goods['id']]);?>"><?php echo ($goods["name"]); ?></a></dd>
									<dd><span>售价：</span><strong> ￥<?php echo ($goods["shop_price"]); ?></strong></dd>
