...
<link href="__STYLE__/general.css" rel="stylesheet" type="text/css" />
<link href="__STYLE__/main.css" rel="stylesheet" type="text/css" />
</head>
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" align="right">
                            <img src="<?php echo U('verify');?>" onclick="this.src='<?php echo U('verify');?>'" />
                        </td>
                    </tr>
                    <tr>
